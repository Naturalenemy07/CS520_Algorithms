...
\begin{itemize}
    ...
    \newpage
        ...
        \begin{center}
            \begin{tikzpicture}
                ...
                \draw[-] (c) to node[left] {1} (e);
                \draw[-] (c) to node[above] {5} (b);
                \draw[-,line width=3pt,color=blue] (b) to node[above left] {1} (f);
                \draw[-] (b) to node[below left] {9} (e);
                \draw[-] (d) to node[above right] {7} (f);
                \draw[-] (d) to node[below right] {14} (e);
        ...
        \begin{center}
            \begin{tikzpicture}
                ...
                \draw[-] (c) to node[right] {2} (f);
                \draw[-] (c) to node[below] {3} (d);
                \draw[-,line width=3pt,color=blue] (c) to node[left] {1} (e);
                \draw[-] (c) to node[above] {5} (b);
                \draw[-,line width=3pt,color=blue] (b) to node[above left] {1} (f);
                \draw[-] (b) to node[below left] {9} (e);
                \draw[-] (d) to node[above right] {7} (f);
        ...
        \begin{center}
            \begin{tikzpicture}
                ...
                \draw[-,line width=3pt,color=blue] (c) to node[right] {2} (f);
                \draw[-] (c) to node[below] {3} (d);
                \draw[-,line width=3pt,color=blue] (c) to node[left] {1} (e);
                \draw[-] (c) to node[above] {5} (b);
                \draw[-,line width=3pt,color=blue] (b) to node[above left] {1} (f);
        ...
        \begin{center}
            \begin{tikzpicture}
                ...
                \draw[-,line width=3pt,color=blue] (c) to node[right] {2} (f);
                \draw[-,line width=3pt,color=blue] (c) to node[below] {3} (d);
                \draw[-,line width=3pt,color=blue] (c) to node[left] {1} (e);
                \draw[-] (c) to node[above] {5} (b);
                \draw[-,line width=3pt,color=blue] (b) to node[above left] {1} (f);
                \draw[-] (b) to node[below left] {9} (e);
        ...
        \item[b)] Prim's algorithm (indicate starting node). \emph{starting node is {\color{purple}\textbf{d}}.}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \draw[-] (c) to node[right] {2} (f);
            \draw[-,line width=3pt, color=purple] (c) to node[below] {3} (d);
            \draw[-,line width=3pt, color=purple] (c) to node[left] {1} (e);
            \draw[-] (c) to node[above] {5} (b);
            \draw[-] (b) to node[above left] {1} (f);
            \draw[-] (b) to node[below left] {9} (e);
            \draw[-] (d) to node[above right] {7} (f);
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \draw[-,line width=3pt, color=purple] (c) to node[right] {2} (f);
            \draw[-,line width=3pt, color=purple] (c) to node[below] {3} (d);
            \draw[-,line width=3pt, color=purple] (c) to node[left] {1} (e);
            \draw[-] (c) to node[above] {5} (b);
            \draw[-] (b) to node[above left] {1} (f);
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \draw[-,line width=3pt, color=purple] (c) to node[left] {1} (e);
            \draw[-] (c) to node[above] {5} (b);
            \draw[-,line width=3pt, color=purple] (b) to node[above left] {1} (f);
            \draw[-] (b) to node[below left] {9} (e);
            \draw[-] (d) to node[above right] {7} (f);
            \draw[-] (d) to node[below right] {14} (e);
